# IMPORTANT!
# implemented linear probing, open adressing code into put() function.
...
class Map:
    ...
    def put(self, key, value):
        ...
        while k <= self.capacity:
            if self.table[k % len(self.table)] != []:
                k += 1
                if k == len(self.table):
                    k = 0
            else:
    ...
    def getHash(self, hashCode):
        return hash(hashCode) & (self.capacity - 1)
